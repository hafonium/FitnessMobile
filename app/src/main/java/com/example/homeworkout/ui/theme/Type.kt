...
/** Bold, chunky type scale matching the storyboard — headings and numbers lean heavier than
 * stock Material so big timers ("00:30"), counters ("9") and titles ("HOME WORKOUT") read the
 * same way they do in docs/system.pdf. */
